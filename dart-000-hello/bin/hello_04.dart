void main(List<String> args) {
  ...
  /// final 선언문은 java, 일반적인 프로그래밍 언어의 fianl 적인 성질을 갖는 변수 선언문이다
  /// 한번 값을 할당(set)하면 다시 값을 변경할 수 없다
  /// const 선언문은 겉보기는 final 과 유사하게 한번 값을 할당(set)하면 다시 값을 변경(set) 할 수 없다
  ...
  /// 매직 리터럴은 실제 코드가 작동되는 과정에서 오류를 일으킬 수 있는 정황을 가지고 있다
